...
firebsever = pyrebase.initialize_app(config=configurations.config)
db = firebsever.database()


firebasevar = firebase.FirebaseApplication(
    'https://subjective-evaluation-22a92-default-rtdb.firebaseio.com')
firebase_apikey = "AIzaSyB-Iwn3Q2rwvnfHpirclyvy5bPRXRoMmOY"
